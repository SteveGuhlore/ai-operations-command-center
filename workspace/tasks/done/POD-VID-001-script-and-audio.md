...
**Script**: 134 words — hits all beats. Hook lands in first 3 seconds with a pain point. The insight shifts at "clients don't respect LOW prices" and builds through the rate-setting reveal. CTA is clear and actionable.

**Audio**: Generated and saved to `workspace/assets/audio/short-form-stop-undercharging.mp3`

**Voice choice**: Nova delivers energetic warmth without pushiness—perfect for a peer talking to peer, not a salesperson talking down.
