...
def test_collect_issues_flags_multidate_backlog_and_oversize(monkeypatch):
    ...
    verdicts = [{"date": "2026-06-09", "symbol": "X"}, {"date": "2026-06-10", "symbol": "Y"}]  # 2 dates
...
def test_collect_issues_single_day_large_is_healthy():
